    ...
    <div id="wrapper">
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark" data-aos="fade-right" data-aos-duration="1200">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#" style="padding-bottom: 0px;padding-top: 0px;">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="faculty.html"><i class="fas fa-table"></i><span>Faculty Management&nbsp;</span></a><a class="nav-link" href="student.html"><i class="far fa-user" style="font-size: 14px;"></i><span>Student Management&nbsp;</span></a></li>
                </ul>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="d-sm-flex justify-content-between align-items-center mb-4" data-aos="fade" data-aos-duration="1150" data-aos-delay="500" style="padding-left: 24px;">
                ...
                <div class="container py-4 py-xl-5">
                    <div class="text-center text-white-50 bg-primary border rounded border-0 p-3">
                        <div class="row row-cols-2 row-cols-md-4">
                            ...
                            <div class="col">
                                <div data-aos="fade-down-left" data-aos-duration="1200" data-aos-delay="700" class="p-3">
                            ...
                            <div class="col">
                                <div data-aos="fade-left" data-aos-duration="1200" data-aos-delay="800" class="p-3">
                                    ...
                                    <p class="mb-0">Under-utilized Faculty <br>(&lt; 2 Courses)</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div style="margin-top: 30px; margin-right: -1px;">
                                                        <div class="container" style="padding-top: 0px; padding-bottom: 0px; margin-bottom: 15px; margin-top: 8px;">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3" style="margin-left: 31px;">
                                                                    <input class="form-control" type="text" name="faculty_name" id="faculty_name" placeholder="Enter Faculty Name" required minlength="2" maxlength="25">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="container" style="padding-top: 0px; padding-bottom: 0px; margin-bottom: 15px; margin-top: 8px;">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input class="form-control" type="text" name="position" id="position" placeholder="Enter Position Name" required minlength="2" maxlength="25">
                                                                </div>
                                                                <div class="col-md-3 col-xxl-1" style="margin-left: 210px; padding-top: 7px;">
                                                                    <strong>Address</strong>
                                                                </div>
                                                                <div class="col-md-3" style="margin-left: 31px;">
                                                                    <input class="form-control" type="text" name="address" id="address" placeholder="Enter Address" required minlength="5" maxlength="50">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="container" style="padding-top: 0px; padding-bottom: 0px; margin-bottom: 15px; margin-top: 8px;">
                                                            <div class="row mb-xxl-3">
                                                                ...
                                                                <div class="col-md-3 ps-xxl-1" style="margin-left: 31px; padding-left: 50px; padding-top: 2px;">
                                                                    <input class="form-control" type="date" name="start_date" id="start_date" style="width: 247.85px;" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="container" style="padding-top: 0px; padding-bottom: 0px; margin-bottom: 15px; margin-top: 8px;">
                                                            <div class="row mb-xxl-3">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input class="form-control" type="number" name="salary" id="salary" placeholder="Enter Salary" required min="3000" max="100000">
                                                                </div>
                                                                <div class="col-md-3 col-xxl-1" style="margin-left: 210px; padding-top: 7px;">
                                                                    <strong>Phone Number</strong>
                                                                </div>
                                                                <div class="col-md-3 ps-xxl-1" style="margin-left: 31px; padding-left: 50px; padding-top: 2px;">
                                                                    <input class="form-control" type="tel" name="phone_number" id="phone_number" placeholder="Enter Phone Number" required pattern="(98|97)\d{8}" maxlength="10" minlength="10">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
