    ...
    <div id="wrapper">
            ...
            <div class="container-fluid d-flex flex-column p-0"><a
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="faculty.php"><i
                            ...
                            href="student.php"><i class="far fa-user" style="font-size: 14px;"></i><span>Student
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4" data-aos="fade" data-aos-duration="1200" data-aos-delay="500">Profile
                    </h3>
                    <div class="row mb-3">
                        <div class="col-lg-4 col-xxl-4">
                            <div class="card mb-3" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="600">
                                <div class="card-body text-center shadow">
                                    ...
                                    <img class="rounded-circle mb-3 mt-4" id="profileImage"
                                        src="assets/img/dogs/image2.jpe" width="160" height="160" alt="Profile Image">
                                    <input type="file" id="fileInput" style="display: none;" accept="image/*">

                                    <div class="mb-3">
                                        <button class="btn btn-primary btn-sm" id="changePhotoBtn" type="button">Change
                                            Photo</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card shadow mb-5" data-aos="fade-right" data-aos-duration="1200"
                                data-aos-delay="750">
                                ...
                                <div class="card-body">
                                    <div class="row" style="padding-bottom: 9px;">
                                        <div class="col-md-6 col-xxl-5"><strong class="text-primary-emphasis">Full
                                                Name:</strong></div>
                                        <div class="col"><strong class="text-primary-emphasis">USERNAME</strong></div>
                                    </div>
                                    <div class="row" style="padding-bottom: 9px;">
                                        <div class="col-md-6 col-xxl-5"><strong
                                                class="text-primary-emphasis">Role:</strong></div>
                                        <div class="col"><strong class="text-primary-emphasis">ADMIN</strong></div>
                                    </div>
                                    <div class="row" style="padding-bottom: 9px;">
                                        <div class="col-md-6 col-xxl-5"><strong class="text-primary-emphasis">Email
                                                Address:</strong></div>
                                        <div class="col"><strong class="text-primary-emphasis">abc@info.com</strong>
                                        </div>
                                    </div>
                                    <div class="row" style="padding-bottom: 9px;">
                                        <div class="col-md-6 col-xxl-5"><strong class="text-primary-emphasis">Phone
                                                NO.:</strong></div>
                                        <div class="col"><strong class="text-primary-emphasis">98123123123</strong>
                                        </div>
                                    </div>
                                    <div class="row" style="padding-bottom: 9px;">
                                        <div class="col-md-6 col-xxl-5"><strong
                                                class="text-primary-emphasis">D.O.B:</strong></div>
                                        <div class="col"><strong class="text-primary-emphasis">2003/11/30</strong></div>
                                    </div>
                                    <div class="row" style="padding-bottom: 9px;">
                                        <div class="col-md-6 col-xxl-5"><strong
                                                class="text-primary-emphasis">Genger:</strong></div>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="card shadow mb-3" data-aos="fade-left" data-aos-duration="1200"
                                        data-aos-delay="600">
                                        <div class="card-header py-3">
                                    ...
                                    <div class="card shadow" data-aos="fade-left" data-aos-duration="1200"
                                        data-aos-delay="750">
                                        <div class="card-header py-3">
