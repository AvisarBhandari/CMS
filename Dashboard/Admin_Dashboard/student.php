                            ...
                            <div class="text-center d-flex flex-column justify-content-center align-items-center py-3">
                                <div
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                        viewBox="0 0 16 16" class="bi bi-person-fill-check">
                                        <path
                        ...
                        <div class="col" data-aos="fade-down-left" data-aos-duration="1200" data-aos-delay="700" data-aos-once="true">
                            <div class="text-center d-flex flex-column justify-content-center align-items-center py-3">
                                <div
                                    class="bs-icon-xl bs-icon-circle bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block mb-2 bs-icon lg">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                        viewBox="0 0 16 16" class="bi bi-person-x-fill">
                ...
                <div class=" pulse animated" style="margin-left: -1px;">
                            ...
                            <div class="row ">
                                <div class="col-md-6 col-xxl-4" data-aos="flip-right" data-aos-duration="1000"
                                    ...
                                    <div class="card shadow mb-4">
                                        <div class="card-header d-flex justify-content-between align-items-center"
                                            style="height: 57.4px;">
                                            <h6 class="text-primary fw-bold m-0">Department-Wise Enrollment past Twelve
                                                Months</h6>
                                        </div>
                                        <div class="card-body">
                                            <div class="chart-area"><canvas id="departmentEnrollmentChart"></canvas>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class=" col-md-6 col-xxl-5" data-aos="flip-left" data-aos-duration="1000"
                                    ...
                                    <div class="card shadow mb-4">
                                        <div class="card-header d-flex justify-content-between align-items-center"
                                            style="height: 57.4px;">
                                            <h6 class="text-primary fw-bold m-0">Course-Wise Enrollment past Twelve
                                                Months</h6>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 text-nowrap">
                                            <div id="dataTable_length" class="dataTables_length"
                                                ...
                                                <div class="dropdown"><button
                                                        ...
                                                        id="studentDropdownButton" data-bs-auto-close="outside"
                                                    ...
                                                    <div class="dropdown-menu"
                                                        ...
                                                        <h3 class="text-light text-bg-primary" id="dropdownbtn"
                                                            style="padding-left: 43%;padding-top: 4px;margin-top: -8px;margin-bottom: 14px;height: 41.6px;">
                                                            Add Student</h3>
                                                        <form style="padding-bottom: 0px;" method="post"
                                                            id="studentForm">
                                                            <div style="margin-top: 30px; margin-right: -1px;">
                                                                ...
                                                                <div class="container"
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <input class="form-control" id="parent_name"
                                                                        ...
                                                                        <div class="col-md-3"
                                                                            ...
                                                                            <input class="form-control" id="address"
                                                                                ...
                                                                                placeholder="Enter Student's adress">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <input class="btn btn-primary" type="submit"
                                                                style="margin-left: 807px;" id="submit_button"
                                                                value="Add Student">
                                                        </form>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu"
                                                style="width: 100%; box-shadow: 0px 0px 20px 1px; padding: 10px;">
                                                <h3 class="text-light text-bg-primary text-center py-1 mb-3"
                                                    id="dropdownbtn">Mark or Edit Attendance</h3>
                                                            ...
                                                            <div class="row mb-2">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <select class="form-control form-control-sm"
                                                                        ...
                                                                        <option value="">Select Course</option>
                                                                        <!-- Dynamic courses will be populated here -->
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="row mb-2">
                                                                <div class="col-md-4"><strong>Attendance Date</strong>
                                                                </div>
                                                                <div class="col-md-8">
                    ...
                    <footer class="bg-white sticky-footer">
                        <div class="container my-auto">
                            <div class="text-center my-auto copyright"><span>Copyright © Academy Keeper 2024</span>
                            </div>
                        </div>
                    </footer>
