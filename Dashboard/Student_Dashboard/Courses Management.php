...
<body id="page-top">
    <div id="wrapper">
            ...
            <div class="container-fluid d-flex flex-column p-0"><a
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar-1">
                    ...
                    <li class="nav-item"><a class="nav-link" href="exam.php"><i
                                class="fas fa-table"></i><span>Examination</span></a><a class="nav-link active"
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="d-sm-flex justify-content-between align-items-center mb-4 ps-5 pe-5" data-aos="fade"
    ...
    <script src="assets/js/course_data/course_subject_data.js"></script>
</body>
