    ...
    <div id="wrapper">
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark" data-aos="fade-right" data-aos-duration="1200" data-aos-once="true">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#" style="padding-bottom: 0px;padding-top: 0px;">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar-1">
                    ...
                    <li class="nav-item"><a class="nav-link" href="exam.php"><i class="fas fa-table"></i><span>Examination</span></a><a class="nav-link active" href="Courses%20Management.php"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-book">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="d-sm-flex justify-content-between align-items-center mb-4 ps-5 pe-5" data-aos="fade" data-aos-duration="1150" data-aos-delay="500">
                    <h3 class="text-dark mb-0">Course Management&nbsp;</h3><a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" data-aos="fade-left" data-aos-duration="800" data-aos-delay="500" data-aos-once="true" href="#"><i class="fas fa-download fa-sm text-white-50"></i>&nbsp;Generate Report</a>
                </div>
                            ...
                            <table class="table my-0" id="dataTable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><em><span style="color: rgb(28, 200, 138);">A</span></em></td>
                                    </tr>
                                    <tr>
                                        <td>13123121</td>
                                        <td>DSA</td>
                                        ...
                                        <td><em><span style="color: rgb(231, 74, 59);">D</span></em></td>
                                    </tr>
                                    <tr>
                                        <td>23131211</td>
                                        <td>Accounting</td>
                                        ...
                                        <td>20</td>
                                        <td class="text-start">3</td>
                                        <td><em><span style="color: rgb(28, 200, 138);">B</span></em></td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr>
