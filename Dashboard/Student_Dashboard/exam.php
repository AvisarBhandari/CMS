...
<body id="page-top">
            ...
            <div id="content">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link"
                                        aria-expanded="false" data-bs-toggle="dropdown" href="#"><span
                                            ...
                                            <?php echo $_SESSION['name']; ?></span><img
                ...
                <div class="container-fluid">
                    <div class="card shadow" data-aos="flip-up" data-aos-duration="700" data-aos-delay="400"
                        ...
                        <label for="semester" class="form class" style="margin-left: 10px;">Select Semester:</label>
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid"
                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody id="exam-routine">
                                        <!-- Exam routine rows will be dynamically appended here -->
                                    </tbody>
                                </table>
                            </div>
                        </div>
    ...
    <script src="assets/js/Timetable/routine.js"></script>
</body>
