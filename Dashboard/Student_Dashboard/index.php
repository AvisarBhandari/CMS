            ...
            <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <ul class="navbar-nav flex-nowrap ms-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small">Your name</span><img class="border rounded-circle img-profile" src="assets/img/untitled-1.png"></a>
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4" style="padding-right: 5px;">
                        <h3 class="text-dark mb-0" data-aos="fade-right" data-aos-duration="850" data-aos-delay="500" data-aos-once="true">Student Dashboard</h3><a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="#"><i class="fas fa-download fa-sm text-white-50"></i>&nbsp;Generate Report</a>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-xl-3 mb-4" data-aos="fade-right" data-aos-duration="850" data-aos-delay="500" data-aos-once="true">
                            <div class="card shadow border-left-primary py-2" style="box-shadow: 0px 0px;">
                                <div class="card-body">
                                    <div class="row g-0 align-items-center">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Assignments Pending</span></div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4" data-aos="fade-down" data-aos-duration="850" data-aos-delay="500" data-aos-once="true">
                            <div class="card shadow border-left-success py-2">
                                <div class="card-body">
                                    <div class="row g-0 align-items-center">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>Outstanding Balance</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span>RS. 5000</span></div>
                                        </div>
                                        <div class="col-auto"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 24 24" width="1em" fill="currentColor" class="fa-2x text-gray-300">
                        ...
                        <div class="col-md-6 col-xl-3 mb-4" data-aos="fade-up" data-aos-duration="850" data-aos-delay="500" data-aos-once="true">
                        ...
                        <div class="col-md-6 col-xl-3 mb-4" data-aos="fade-left" data-aos-duration="800" data-aos-delay="500" data-aos-once="true">
                            <div class="card shadow border-left-warning py-2">
                                <div class="card-body">
                                    <div class="row g-0 align-items-center">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-warning fw-bold text-xs mb-1"><span>Credits Earned</span></div>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-xl-4" data-aos="fade-right" data-aos-duration="800" data-aos-delay="500" data-aos-once="true">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="chart-area"><canvas data-bss-chart="{&quot;type&quot;:&quot;pie&quot;,&quot;data&quot;:{&quot;labels&quot;:[&quot;Assignment Completion &quot;,&quot;Assignment Pending&quot;],&quot;datasets&quot;:[{&quot;label&quot;:&quot;Assignment Completion vs. Pending&quot;,&quot;backgroundColor&quot;:[&quot;rgb(30,122,109)&quot;,&quot;rgb(229,5,58)&quot;],&quot;borderColor&quot;:[&quot;rgba(0,0,0,0.1)&quot;,&quot;rgba(0,0,0,0.1)&quot;],&quot;data&quot;:[&quot;85&quot;,&quot;15&quot;]}]},&quot;options&quot;:{&quot;maintainAspectRatio&quot;:false,&quot;legend&quot;:{&quot;display&quot;:true,&quot;labels&quot;:{&quot;fontStyle&quot;:&quot;bold&quot;,&quot;fontColor&quot;:&quot;#6777ef&quot;,&quot;fontSize&quot;:14},&quot;reverse&quot;:false,&quot;position&quot;:&quot;bottom&quot;},&quot;title&quot;:{&quot;fontStyle&quot;:&quot;normal&quot;,&quot;display&quot;:false}}}"></canvas></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 mb-4" data-aos="fade-left" data-aos-duration="650" data-aos-delay="550" data-aos-once="true">
