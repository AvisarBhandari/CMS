    ...
    <div id="wrapper">
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark" data-aos="fade-right" data-aos-duration="1200" data-aos-once="true">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#" style="padding-bottom: 0px;padding-top: 0px;">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar-1">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="time_table.php"><i class="fas fa-calendar-alt" style="font-size: 13px;"></i><span>Time Table&nbsp;</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="d-sm-flex justify-content-between align-items-center mb-4 ms-0 ps-4 pe-4">
                    <h3 class="text-dark mb-0" data-aos="fade-right" data-aos-duration="800" data-aos-delay="550" data-aos-once="true">Time Table</h3><a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" data-aos="fade-left" data-aos-duration="550" data-aos-delay="650" data-aos-once="true" href="#"><i class="fas fa-download fa-sm text-white-50"></i>&nbsp;Generate Report</a>
                </div>
                <div class="card shadow" data-aos="flip-up" data-aos-duration="1200" data-aos-delay="500" data-aos-once="true" style="box-shadow: 0px 0px 20px;">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 fw-bold">Today's TimeTable</p>
                    </div>
                    <div class="card-body">
