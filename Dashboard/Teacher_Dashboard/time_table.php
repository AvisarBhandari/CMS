...
<body id="page-top">
        ...
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark"
            ...
            <div class="container-fluid d-flex flex-column p-0"><a
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="time_table.php"><i class="fas fa-calendar-alt"
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="d-sm-flex justify-content-between align-items-center mb-4 ms-0 ps-4 pe-4">
                    <h3 class="text-dark mb-0" data-aos="fade-right" data-aos-duration="800" data-aos-delay="550"
                        data-aos-once="true">Time Table</h3>
                </div>
                ...
                <div class="card shadow" data-aos="flip-up" data-aos-duration="1200" data-aos-delay="500"
                    ...
                    <div class="card-body">
                        <!-- Day selection form -->
                        <form id="daySelectForm" class="mb-3">
    ...
    <script src="assets/js/Timetable/fetch_timetable.js"></script>
</body>
</html>